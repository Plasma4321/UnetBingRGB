"""
    Problem:1 Supposed you stopped at epoch 8 and the best iou is .43 then you retrain the model from there to epoch 15 and the best iou will
    get replaced with .42 even if the prev best iou was .43 because the model at the start of training best iou is set to 0
...
def main(args):
    ...
    transform = transforms.Compose([    
        transforms.ToTensor(),
        transforms.Normalize(mean=[0.00536, 0.00556,  0.00391],  # New Mean
                         std=[0.00235, 0.00193, 0.00171]) 
    ])
