...
if __name__ == '__main__':
    ...
    parser.add_argument("--best_model_path", type=str, default="/home/temp/LulcBingRGBUnet/checkpointsUsing2GPu/best_model.pth",help="Path to save the best model checkpoint")#
    parser.add_argument("--losses_path", type=str, default="/home/temp/LulcBingRGBUnet/checkpointsUsing2GPu/losses.pth",help="Path to all losses of model")#
    ...
    parser.add_argument("--checkpoint_path", type=str, default= '/home/temp/LulcBingRGBUnet/checkpointsUsing2GPu/checkpoint.pth', help='Saved model path')
