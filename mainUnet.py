...
if __name__ == '__main__':
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('/home/temp/LulcBingRGBUnet/outputs/App.log')  # Log to file "app.log"
        ]
    )
    ...
    parser.add_argument("--batch_size", type=int, default=20, help="Batch size for training (default: 32)")

    parser.add_argument("--best_model_path", type=str, default="/home/temp/LulcBingRGBUnet/checkpoints/best_model.pth",help="Path to save the best model checkpoint")#
    parser.add_argument("--losses_path", type=str, default="/home/temp/LulcBingRGBUnet/checkpoints/losses.pth",help="Path to all losses of model")#
    ...
    parser.add_argument("--checkpoint_path", type=str, default= '/home/temp/LulcBingRGBUnet/checkpoints/checkpoint.pth', help='Saved model path')
