...
def train(args, model, train_loader, test_loader, device, restart=False):
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='max', factor=0.95, patience=5, threshold=0.001)
...
#/home/temp/LulcBingRGBUnet/DataDummy/
    ...
    parser.add_argument("--lr", type=float, default=0.01, help="Learning rate for training (default: 0.001)")
